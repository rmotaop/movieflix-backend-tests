...
INSERT INTO tb_movie (title, sub_Title, year, img_Url, synopsis, genre_id) VALUES ('Tribos da Europa', 'The future is not what you expected.', 2021, 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/ewEgxHvSJnQxH4nwYUr8yajqHOQ.jpg', 'Em 2070, três irmãos lutam para mudar o destino da Europa após uma catástrofe global ter dividido o continente em microestados que disputam o poder.', 1);
...
INSERT INTO tb_movie (title, sub_Title, year, img_Url, synopsis, genre_id) VALUES ('Carga Explosiva 3', 'Carga Explosiva 3', 2008, 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/v7hHxGSbL5gE0y8MuJvkgI44KsC.jpg', 'Frank Martin (Jason Statham) é obrigado a conduzir Valentina (Natalya Rudakova), a filha de Leonid Vasilev (Jeroen Krabbé), o chefe da Agência de Proteção Ambiental da Ucrânia. Ela foi sequestrada por Jonas Johnson (Robert Knepper), contratado por uma empresa de gerenciamento internacional de resíduos que deseja operar na Ucrânia. Para ter Frank e Valentina sob controle, Jonas prende em seus pulsos um dispositivo que determina que não possam se afastar muito do carro que os conduz, caso contrário o bracelete explode. Contando com a ajuda do inspetor Tarconi (François Berléand), Frank busca um meio de deixar a armadilha.', 3);
INSERT INTO tb_movie (title, sub_Title, year, img_Url, synopsis, genre_id) VALUES ('O Reino Proibido', 'The battle for eternity is the fantasy of a lifetime.', 2008, 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/aNKhC2nzGr3kAggKubJ56MbFOUc.jpg', 'Jason, um adolescente americano, é um grande fã do cinema de Hong Kong e de velhos filmes de kung-fu. Ao visitar uma loja de penhores em Chinatown, ele descobre a arma de um sábio chinês antigo e guerreiro, o Rei Macaco. A relíquia mágica transporta Jason de volta no tempo e ele se junta a um grupo de lendários artistas marciais em uma missão para libertar um homem preso.', 3);
INSERT INTO tb_movie (title, sub_Title, year, img_Url, synopsis, genre_id) VALUES ('Zona de Combate', 'Defiant by design.', 2021, 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/lOSdUkGQmbAl5JQ3QoHqBZUbZhC.jpg', 'Em um futuro próximo, um piloto de drone e um androide ultrassecreto trabalham lado a lado no campo de batalha para evitar um ataque nuclear.', 3);
INSERT INTO tb_movie (title, sub_Title, year, img_Url, synopsis, genre_id) VALUES ('Venom: Tempo de Carnificina (2021)', 'Venom: Let There Be Carnage', 2021, 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/lNyLSOKMMeUPr1RsL4KcRuIXwHt.jpg', 'Em busca de seu próximo furo de reportagem, o jornalista Eddie Brock consegue uma entrevista exclusiva com Cletus Kasady, um assassino no corredor da morte, que descobre o segredo de Eddie e se torna o hospedeiro de Carnificina, um simbionte aterrorizante e ameaçador. Eddie e Venom precisam superar sua relação atribulada e trabalhar em conjunto para derrotar Carnificina.', 5);
INSERT INTO tb_movie (title, sub_Title, year, img_Url, synopsis, genre_id) VALUES ('Homem-Aranha: Através do Verso-Aranha - Parte Um', 'Em Produção', 2022, 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/brEz4q9qCC9sKOsW2q40k0BLLci.jpg', 'A história de Miles Morales e a web #SpiderVerse se expandem. Dê uma olhada primeiro em Homem-Aranha: Across the Spider-Verse (Parte Um). Exclusivamente nos cinemas em outubro de 2022.', 4);

INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Filme envolvente, incrível a história e roteiro do filme.', 1, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Filme muito estranho, pesado, não gostei nao!', 1, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Esse filme é muito perturbador, nos trás a realidade vivida por muitas mulheres.', 2, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Apesar de ser novo já assiste duas vezes, não canso de ver esse filmeee.', 3, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Filme bacana, mas da um certo tédio', 4, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('A história é interessante, mas não nos deixa com vontade de ver novamente', 5, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('O melhor filme que já passou na sessão da tarde!!!', 6, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Liga da justiça é muito bom, shoow, terá mais? Sim, sim, sim', 7, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Considero esse filme muito ruim, só acho', 8, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Esse filme é uma comédia do início ao fim, ha ha ha', 9, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Esse filme devia estar como máxima no IMDb,  filmaço', 10, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Eu acho muito chato esses filmes de luta, não curto', 11, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Esse filme promete muito tal qual p promeiro,  filmaço', 13, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Eu acho que esse filme abre muitas portas e discussões sobre vários temas', 14, 1);
INSERT INTO tb_review (text, movie_id, user_id) VALUES ('Eu acho muito chato esses filmes de luta, não curto', 11, 1);
